...
// IR
int RECV_PIN = 6, IR_BUTTON_CODE = 0xFD00FF;
...
void loop() {
  ...
  // Delay added so that the simulation doesn't take too long
  delay(200);
...
// Else return true
bool isGateFreeToGo(int centimeters) {
...
// 1. Generate the ultrasound by setting the Trigger Pin to HIGH
// 2. Wait around 10ms
// 3. Clear the Trigger Pin
